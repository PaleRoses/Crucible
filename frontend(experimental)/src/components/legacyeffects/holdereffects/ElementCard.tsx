...
/**
 * InfoCard Component - Information Display with Advanced Scroll Behavior
 * 
...
const ElementCard = React.memo(InfoCard);
ElementCard.displayName = 'ElementCard';

/**
 * GoldenInfoCard Component
 * 
 * A preset version of InfoCard with a golden/amber color scheme.
 * 
 * @param {Object} props - Same props as InfoCard with color presets
 */
export const GoldenElementCard: React.FC<InfoCardProps> = (props) => {
  const goldenPreset = {
    highlightColor: '#bfad7f',
    textColor: 'rgba(224, 224, 224, 0.7)',
    fontFamily: '"Garamond", "Adobe Caslon Pro", serif',
...
/**
 * NightInfoCard Component
 * 
 * A preset version of InfoCard with a blue-tinted dark color scheme.
 * 
 * @param {Object} props - Same props as InfoCard with color presets
 */
export const NightElementCard: React.FC<InfoCardProps> = (props) => {
  const nightPreset = {
...
/**
 * ElegantInfoCard Component
 * 
 * A preset version of InfoCard with an elegant maroon/burgundy color scheme.
 * 
 * @param {Object} props - Same props as InfoCard with color presets
 */
export const ElegantElementCard: React.FC<InfoCardProps> = (props) => {
  const elegantPreset = {
